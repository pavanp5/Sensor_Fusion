...
configs_det.use_labels_as_objects =  True #= use groundtruth labels as objects, False = use model-based detection
    ...
    try:
        ...
        if 'perform_tracking' in exec_list:
            ...
            for detection in detections:
                det_cnt = det_cnt + 1
                #print("detection {},{}",det_cnt,cnt_frame)
                ...
                if detection[1] > configs_det.lim_x[0] and detection[1] < configs_det.lim_x[1] and detection[2] > configs_det.lim_y[0] and detection[2] < configs_det.lim_y[1]:
                    #print("Lidar box.center_x, box.center_y{}",detection[1:])
